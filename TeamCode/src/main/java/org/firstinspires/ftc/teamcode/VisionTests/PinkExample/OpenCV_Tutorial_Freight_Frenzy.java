package org.firstinspires.ftc.teamcode.VisionTests.PinkExample;
...
public class OpenCV_Tutorial_Freight_Frenzy extends LinearOpMode {
    ...
    private double leftBarcodeRangeBoundary = .3; //i.e 30% of the way across the frame from the left
    private double rightBarcodeRangeBoundary = .6; //i.e 60% of the way across the frame from the left
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        pipeline = new ContourPipeline(0, 0, 0.2, 0.2);
...
//                }
                ...
                if(pipeline.getRectMidpointX() > 800){
                    telemetry.addData("Barcode Position", "Right");
                }
                else if(pipeline.getRectMidpointX() < 400){
                    telemetry.addData("Barcode Position", "Left");
                }
                else {
                    telemetry.addData("Barcode Position", "Center");
